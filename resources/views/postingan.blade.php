                     ...
                     <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <form action="{{ url('postup/') }}" method="post" enctype="multipart/form-data">
                              ...
                              <div class="d-flex align-items-center">
                                 <div class="user-img">
                                    <img src="{{session()->get('photo') }}" alt="userimg" class="avatar-60 rounded-circle img-fluid">
                                 </div>
                                 <input type="text" name="caption" class="form-control rounded" placeholder="Tulis keterangan disini..." style="border:none;">
                              </div>
                              <hr>
                  ...
                  <div class="user-post-data">
                     <div class="d-flex justify-content-between">
                        ...
                        <div class="w-100">
                           <div class=" d-flex  justify-content-between">
                              <div class="">
                                 <h5 class="mb-0 d-inline-block"><a href="/profile">{{ $post->username }}</a></h5>
         ...
         <div class="col-sm-12">
            <div class="card card-block card-stretch card-height">
               <div class="card-body">
                  ...
                  <div class="user-post">
                     <a href="javascript:void();"><img src="{{ $post->image }}" alt="post-image" class="img-fluid rounded w-100"></a>
                  </div>
