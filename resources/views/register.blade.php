                ...
                <div class="row no-gutters">
                    <div class="col-md-6 text-center pt-5">
                        <div class="sign-in-detail text-white">
                            <a class="sign-in-logo mb-5" href="#"><img src="images/logo_baru2.png"
                            ...
                            <div class="sign-slider overflow-hidden ">
                                <ul class="swiper-wrapper list-inline m-0 p-0 ">
                                    <li class="swiper-slide">
                                        ...
                                        <p>Belum terlambat untuk mengembangkan persahabatan baru atau berhubungan
                                            kembali dengan orang-orang.</p>
                                    </li>
                                    <li class="swiper-slide">
                                        <img src="images/login/tani2.jpeg" class="img-fluid mb-4" alt="logo">
                                        <h4 class="mb-1 text-white">Jelajahi Dunia Baru</h4>
                                        <p>Dunia adalah milikmu dan semua yang ada di dalamnya, ada di luar sana-
                                            kerjakan pekerjaanmu dan dapatkan itu.</p>
                                    </li>
                                    <li class="swiper-slide">
